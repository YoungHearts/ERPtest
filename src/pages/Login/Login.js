...
export default class Login extends Component {
    ...
    _login = () => {
        ...
        GEM.axios.get('https://facebook.github.io/react-native/movies.json').then((res)=>{
            console.log(res);
            this.props.navigation.goBack();//登录后返回
        });
